...
func progressUpdate (steps: Int, goal: Int) {
    let goal10 = goal * Int(0.1)
    let goal50 = goal * Int(0.5)
    let goal90 = goal * Int(0.9)
    if steps < goal10 {
        print("You're off to a good start.")
    }else if steps < goal50{
        print("You're almost halfway there!")
    }else if steps < goal90 {
...
pacing(currentDistance: 10000, totalDistance: 30000, currentTime: 2, goalTime: 6)
